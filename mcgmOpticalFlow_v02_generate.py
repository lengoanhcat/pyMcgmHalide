...
from opticalFlowEstimate_v02 import *
...
def main():
    ...
    input_func = constant_exterior(input,Expr(0.0))
    # input_func.parallel(t).vectorize(x,4).compute_root()
    ...
    d_cspec.parallel(t).vectorize(x,4).compute_root()
    ...
    # d_cspec.compile_to_file("mcgmOpticalFlow_v02_halide",args)
    # Tx.compile_to_file("mcgmOpticalFlow__v02_halide",args)
    # stBasis.compile_to_file("mcgmOpticalFlow_v02_halide",args)
    # optFlw.compile_to_c("mcgmOpticalFlow_halide",args,"mcgmOpticalFlow_halide.c")
    optFlw.compile_to_file("mcgmOpticalFlow_v02_halide",args)
