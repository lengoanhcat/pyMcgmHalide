...
def main():
    ...
    if error:
        ...
        outVid = imageio.get_writer('mcgmOpticalFlow_v02_grating.avi',fps=fps)
        ...
        for iF in range(0,np.uint16(noFrm)):
            ...
            # cv2.imshow('orientation',normRgbFrame)
            # cv2.waitKey(0)
            ...
            # Color Derivative
            colDer = outVidData[0][...,iF]
            cv2.imshow('colDer',colDer)
            outVid.append_data(colDer)
